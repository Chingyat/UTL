...
fast_unary_assert(assertType::Enum at, const char *file, int line,
...
#define DOCTEST_TEST_CASE_TEMPLATE_DEFINE_IMPL(dec, T, id, anon)               \
  ...
  template <typename Type> struct DOCTEST_CAT(id, ITERATOR)<Type> {            \
    DOCTEST_CAT(id, ITERATOR)                                                  \
    (int line, int index) {                                                    \
      DOCTEST_REGISTER_TYPED_TEST_CASE_IMPL(anon<Type>, Type, dec,             \
                                            line * 1000 + index);              \
...
#define DOCTEST_FAST_UNARY_ASSERT(assert_type, ...)                            \
  doctest::detail::fast_unary_assert(doctest::assertType::assert_type,         \
...
#define DOCTEST_DEBUG_OUTPUT_WINDOW_REPORTER_OVERRIDE(func, type)              \
  ...
  DOCTEST_DEBUG_OUTPUT_WINDOW_REPORTER_OVERRIDE(log_message,
                                                const MessageData &)
